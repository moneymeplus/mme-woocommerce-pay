...
if($woocommerce->cart->total >= 1000){
    echo '<span id="mme-proceed-pay"></span>';
}
?>
<div id="container-mme" class="m-442218 mme-gateway">
    <input type="hidden" id="mme-endpoint" value="<?php echo $site_ep;?>" />
                ...
                <div class="modal-body">
                    <div class="checkout-wrap user-wrap">
                        <div class="mme-logo-wrap text-center">
                            <img src="<?php echo $img;?>/mme_logo-login.svg" />
                        </div>
    ...
    <!-- User signup -->
    <div id="mme-signup-container" class="modal" id="" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true" data-backdrop="false">
                ...
                <div class="modal-body">
                    ...
                    <div class="checkout-wrap signup-wrap">
                        ...
                        <div class="mme-signup-loading text-center">
                            <img src="<?php echo $img;?>/spinner_large.svg" class="pre-loader-icon"/>
                        </div>
                        ...
                        <div class="text-center mme-existing-account">
                            <img src="<?php echo $img;?>/user_icon.png" alt="">
    ...
    <!-- User login -->
    <div id="mme-login-container" class="modal" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true"  data-backdrop="false">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id=""></h5>
                ...
                <div class="modal-body">
                    <div class="checkout-wrap login-wrap">
                        <div class="mme-logo-wrap text-center">
                            <img src="<?php echo $img;?>/mme_logo-login.svg" alt="MME Pay logo" />
                        </div>
    ...
    <!--- forgot password --->
    <div id="mme-forgot-container" class="modal" id="" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true"  data-backdrop="false">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id=""></h5>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="checkout-wrap login-wrap set-pass">
                        <div class="mme-logo-wrap text-center">
                            <img src="<?php echo $img;?>/mme_logo-login.svg" alt="MME Payment Logo">
                        </div>
                        <div class="loading pin-loading text-center mme-login-loading">
                            <img src="<?php echo $img;?>/spinner_large.svg" class="pre-loader-icon"/>
                        </div>
                ...
                <div class="modal-body" style="min-height: 510px;">
                    ...
                    <div class="payment-success-content sms-sent-content">
                        <div id="sms-content-loading">
                            <img class="animated zoomIn spinner" src="<?php echo $img;?>/spinner_large.svg" />
                        ...
                        <div id="sms-content-continue">
                            <img class="animated fadeIn sms-logo" src="<?php echo $img;?>/logo-only.svg" />
    ...
    <div id="mme-account-modal" class="modal" id="" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true"  data-backdrop="false"></div> 
            ...
            <div class="modal-content modal-content-inner">
                ...
                <div class="modal-body" style="min-height: 460px;">
                    <div class="payment-success-content app-success-content">
                        <img class="animated zoomIn sccs-pymnt-spinner" src="<?php echo $img;?>/spinner_large.svg" />
    ...
    <div id="mme-passcode-updated" class="modal" id="" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true" data-backdrop="false">
        <div class="modal-dialog" role="document">
            <div class="modal-content modal-content-inner">
                ...
                <div class="modal-body" style="min-height: 460px;">
                    <div class="payment-success-content app-success-content">
                        <img class="animated zoomIn" src="<?php echo $img;?>/icon-check.svg" />
